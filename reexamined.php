...
define('APP_TITLE', 'reexamined');

$dauth = false;

$auth_users = array(
    'admin' => 'fd68a4bc642f1d79f881c7f7e0bd12c4',
    'user' => 'fd68a4bc642f1d79f881c7f7e0bd12c4'
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="." target="_blank" class="app-v-title"> reexamined <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="." target="_blank" class="float-right text-muted">reexamined <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="." target="_blank" class="float-right text-muted">reexamined <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'reexamined<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="reexamined">
...
function lng($txt) {
    ...
    $tr['en']['AppName']        = 'reexamined';      $tr['en']['AppTitle']           = 'reexamined';
